...
His research broadly lies at the data analytics with the help of cutting edge technique of machine learning to support parctioners who are producing, maintaining and evolving large scale compldex software systems. In particular, his research is focused on mining software repositories (MSR), source code analysis and mobile app mining. His research works published in top Software Engineering venues (e.g., [TSE (Scopus IF: 8.6)](https://www.computer.org/csdl/journal/ts), [EMSE (Scopus IF: 6.2)](https://www.springer.com/journal/10664), [MSR (Core A)](https://conf.researchr.org/series/msr), and [SANER (Core A)](https://saner2021.shidler.hawaii.edu/)).
